export default [
	...
	},
	{
		...
		description:
			"In this project, I illustrated the fictional word 'Himmelwasser' through custom lettering. The letters were first drawn as water droplets in Procreate and then refined using a 3D software, giving them depth and texture. ",
	},
	{
		id: 3,
	...
	},
	{
		...
		description:
			'This typeface is inspired by the dark wave and goth aesthetics of the 80s, capturing the mood and style of the era. The design blends sharp and subtle curves, creating a bold and mysterious look.',
	},
	{
		id: 5,
		label: 'UX, UI',
		...
		iconPath:
			'M17.7394 3.94843L3.26143 18.4264M17.7394 3.94843L17.7394 18.7977M17.7394 3.94843L2.8902 3.94843',
		altText: 'Navigate to the Website of RDRGZ Corporate Relations',
		description:
			'Working with the RDRGZ Corporate Relations team, I developed the concept, strategy, user experience, and user interface for their contact page. The page was designed to make it easier for both users and our team to address inquiries. It’s a process-driven page that guides users step-by-step, allowing them to select their concern and receive tailored next steps based on their input.',
	},
	{
		id: 6,
		label: 'Graphic',
		...
		category: ['Graphic'],
		url: 'https://schule-muss-anders.de/',
		target: '_blank',
		iconPath:
			'M17.7394 3.94843L3.26143 18.4264M17.7394 3.94843L17.7394 18.7977M17.7394 3.94843L2.8902 3.94843',
		altText: 'Navigate to the Website of "Schule in Not e.V."',
		description:
			"I designed a flyer, a demo poster and a demand poster for politicians for the campaign 'Schule muss anders' (School must change) of the association Schule in Not e.V.. These materials support the movement for inclusive and sustainable schools.",
	},
	{
		id: 7,
		...
		description:
			"A sophisticated logo designed for the fictional premium whiskey distillery 'Keltinger.' The design captures the brand's essence by combining timeless elegance with a bold, authentic character.",
	},
	{
		id: 8,
		label: 'Graphic, Branding',
		...
		category: ['Graphic', 'Branding'],
		description:
			"For the fictional social media platform 'Flux', which specialises in content from the film and TV industry, I developed a dynamic and modern logo.",
	},
	{
		id: 9,
		label: 'Graphic, Branding',
		...
		category: ['Graphic', 'Branding'],
		description:
			'I designed the logo for Coffee-Guild, a fictional coffee roastery dedicated to sustainable coffee.',
	},
	{
		id: 10,
		label: 'Graphic, Branding',
		...
		category: ['Graphic', 'Branding'],
		description:
			'I designed a logo for the fictional company "Spread!", which specialises in flower seeds.',
	},
	{
		id: 11,

				...
				<div className="card--centered card__color--red">
					<div className="card__info">
						...
						<p>
							...
							craftsmanship to digital interfaces. My training in UI design, UX
							strategy, web development, and communication design equips me to
							tackle complex challenges creatively and effectively.
						</p>
					</div>
				</div>
				<div className="card--centered card__color--red">
